...
`<project-cli> project check` and `<project-cli> template ...`. Those commands are functional
project interfaces implemented under `tools/`; they do not import this directory.
